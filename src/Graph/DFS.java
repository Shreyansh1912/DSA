...
class Solution {
    ...
    private void DFS(ArrayList<ArrayList<Integer>> adj, int V, int currentVertex, boolean[] visited, ArrayList<Integer> answer){
        ...
        for(int currentNeigh : adj.get(currentVertex)){
           DFS(adj, V, currentNeigh, visited, answer); 
        }
       return; 
    }     
}
